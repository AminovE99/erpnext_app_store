(function () {
		...
		make_row() {
			...
			this.columns.forEach(function (field) {
				...
				cell.innerHTML = this$1.doc[field.fieldname] &&
					formatter(this$1.doc[field.fieldname], field, {only_value: 1}, this$1.doc) || "";
			});
	...
	class WebForm extends frappe.ui.FieldGroup {
		...
		setup_primary_action() {
			...
			this.add_button(this.button_label || "Save", "primary", function () { return this$1.save(); }
			);
		}
		...
		setup_cancel_button() {
			...
			this.add_button("Cancel", "light", function () { return this$1.cancel(); });
		}

		setup_delete_button() {
			var this$1 = this;

			this.add_button("Delete", "danger", function () { return this$1.delete(); });
		}
