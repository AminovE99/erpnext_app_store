(function () {
    ...
    // ignored /home/emil/erpnext_app_store/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
    ...
    frappe.ui.form.ControlMultiSelectList = frappe.ui.form.ControlData.extend({
    	...
    	update_status: function update_status() {
    		...
    		if (this.values.length === 0) {
    			...
    			text = this._options.find(function (opt) { return opt.value === val; }).label;
    		} else {
